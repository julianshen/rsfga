...
/// Request for listing objects a user has access to.
#[derive(Debug, Clone)]
pub struct ListObjectsRequest {
    /// The store ID to query.
    pub store_id: String,
    /// The user to check access for (e.g., "user:alice").
    pub user: String,
    /// The relation to check (e.g., "viewer").
    pub relation: String,
    /// The object type to list (e.g., "document").
    pub object_type: String,
    /// Contextual tuples to consider during the query.
    pub contextual_tuples: Arc<Vec<ContextualTuple>>,
    /// CEL evaluation context variables.
    pub context: Arc<HashMap<String, serde_json::Value>>,
}
...
impl ListObjectsRequest {
    ...
    /// Creates a new ListObjectsRequest with contextual tuples.
    pub fn with_contextual_tuples(
        store_id: impl Into<String>,
        user: impl Into<String>,
        relation: impl Into<String>,
        object_type: impl Into<String>,
    ...
    /// Creates a new ListObjectsRequest with contextual tuples and CEL context.
    pub fn with_context(
        store_id: impl Into<String>,
        user: impl Into<String>,
        relation: impl Into<String>,
...
pub struct ListObjectsResult {
    /// The objects the user has access to (in "type:id" format).
